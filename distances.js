...
function calc() {
    ...
    if (marker1 !== null && marker2 !== null) {
        ...
        globaldistance = haversine_distance(marker1, marker2);
        document.getElementById('msg').innerHTML = "Distance between markers: " + globaldistance.toFixed(2) + " km.";
    } else {
